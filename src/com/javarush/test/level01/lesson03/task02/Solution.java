...
public class Solution
{
    ...
    {
        String name = "Вывод на экран переменной: Объявите переменную name типа String. Сразу же в строке объявления присвойте ей какое-нибудь значение. Выведите на экран переменную name.";
